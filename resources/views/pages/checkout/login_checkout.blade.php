    ...
    <div class="row">
				...
				<form class="box" action="{{URL::to('/login-customer')}}" method="POST">
					...
					<div class="input-div one">
						...
						<div class="div">
							...
							<input class="admin_email" name="email_account" placeholder="Tài khoản">
						</div>
					</div>
					<div class="input-div pass">
						...
						<div class="div">
							...
							<input class="admin_password" type="password"  name="password_account" placeholder="Password">
						</div>
						<span>
		...
		<div class="col-sm-5">
			<div class="signup-form"><!--sign up form-->
						<h2>ĐĂNG KÝ</h2>
						<form  class="add"action="{{URL::to('/add-customer')}}" method="POST">
							{{ csrf_field() }}
